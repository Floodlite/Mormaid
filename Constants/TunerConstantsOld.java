...
public class TunerConstantsOld {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withKS(0.05).withKV(2.66).withKA(0)
    ...
    //CANcoder: Measures absolute position and velocity
    //Pigeon: Accelerometer, gyroscope, and magnetometer
    ...
    public static final CANBus kCANBus = new CANBus("1515Canivore", "./logs/example.hoot");
    ...
    //Assigns configuration settings
    public static final SwerveDrivetrainConstants DrivetrainConstants = new SwerveDrivetrainConstants()
            .withCANBusName(kCANBus.getName())
            .withPigeon2Id(kPigeonId)
            .withPigeon2Configs(pigeonConfigs);

    //Assigns various Swerve drive values
    ...
    //Values tied to different motors in each corner of the drive base
    ...
    //Applies settings to each motor
