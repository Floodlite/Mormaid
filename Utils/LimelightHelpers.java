...
/*Pose
* Pose refers to position + orientation. 
* A rigid body in space has six degrees of freedom, 
* divided into three translational and three rotational.
*/

//https://limelightlib-wpijava-reference.limelightvision.io/allclasses-index.html

public class LimelightHelpers {

    //https://docs.limelightvision.io/docs/docs-limelight/apis/json-results-specification
    //Creates a double array to store location and rotation values
    private static final Map<String, DoubleArrayEntry> doubleArrayEntries = new ConcurrentHashMap<>();

    /* Retroflective and Fiducial Vision
     * Retroreflective (Retro): Uses colored reflective pieces of tape to detect objects
     * Fiducial: Uses special pieces of paper with patterns (AprilTags) to detect objects
     */
    public static class LimelightTarget_Retro {
        //Retrieves pose values from the Limelight's JSON document

        //Local pose of camera relative to the target/tag
        @JsonProperty("t6c_ts")
        private double[] cameraPose_TargetSpace;

        //Global pose of robot (relative to the entire field)
        @JsonProperty("t6r_fs")
        private double[] robotPose_FieldSpace;

        //Local pose of robot relative to the target
        @JsonProperty("t6r_ts")
        private  double[] robotPose_TargetSpace;
        
        //Local pose of target/tag relative to the camera
        @JsonProperty("t6t_cs")
        private double[] targetPose_CameraSpace;

        //Local pose of target/tag relative to the robot
        @JsonProperty("t6t_rs")
        private double[] targetPose_RobotSpace;


        //Overload methods corresponding to the poses of different origins to different targets in 3D
        //Pose of camera to target in 3D
        ...
        //Pose of robot to target in 3D
        public Pose3d getRobotPose_TargetSpace()
        {
            return toPose3D(robotPose_TargetSpace);
        }
        //Pose of target to camera in 3D
        public Pose3d getTargetPose_CameraSpace()
        {
            return toPose3D(targetPose_CameraSpace);
        }
        //Pose of target to robot in 3D
        public Pose3d getTargetPose_RobotSpace()
        {
            return toPose3D(targetPose_RobotSpace);
        }

        //Overload methods corresponding to the poses of different origins to different targets in 2D
        //Pose of camera to target in 2D
        public Pose2d getCameraPose_TargetSpace2D()
        {
            return toPose2D(cameraPose_TargetSpace);
        }
        //Pose of robot in the field in 2D
        public Pose2d getRobotPose_FieldSpace2D()
        {
            return toPose2D(robotPose_FieldSpace);
        }
        //Pose of robot to target in 2D
        public Pose2d getRobotPose_TargetSpace2D()
        {
            return toPose2D(robotPose_TargetSpace);
        }
        //Pose of target to camera in 2D
        public Pose2d getTargetPose_CameraSpace2D()
        {
            return toPose2D(targetPose_CameraSpace);
        }
        //Pose of target to robot in 2D
        public Pose2d getTargetPose_RobotSpace2D()
        {
            return toPose2D(targetPose_RobotSpace);
        }

        //Retrieves target information from the Limelight JSON
        //Size of the target as a percentage of the image (0-1)
        @JsonProperty("ta")
        public double ta;
        ...
        //Array of pixels on the border of the screen 
        //[x0,y0,x1,y1.....]. 
        //Must be enabled in output tab
        @JsonProperty("ts")
        public double ts;

        //Creates five 6-element long arrays corresponding to each pose value
    ...
    //Same as Retro class but with Fiducial values instead
    ...
    //Results from barcodes (unimplemented)
    ...
    //Tries to figure out **What** is in the image
    public static class LimelightTarget_Classifier {

        //Class: Type of object to detect
        @JsonProperty("class")
        public String className;

        //Class ID: Number assigned to each object/class
        @JsonProperty("classID")
        public double classID;

        //Confidence: Lenience of detection
        @JsonProperty("conf")
        public double confidence;

        //Zone: Part of the camera that objects will be searched for
        //More efficient when the zone is smaller
        @JsonProperty("zone")
        public double zone;

        //Same pixel and pose types from other classes
        @JsonProperty("tx")
        public double tx;
    ...
    //Identifies the location of targets in camera images
    //Tries to figure out **Where** the targets are in the image
    ...
    //(Presumably) Returns information from the Limelight
    public static class LimelightResults {
        ...
        //Arrays storing Limelight results
    ...
    public static class PoseEstimate {
         ...
         */
        ////P.S. Most classes from this point already have documentation comments
        public PoseEstimate() {
    ...
    /**
     * Print JSON Parse time and Limelight information to the console in milliseconds
     */
    ...
    //Publishes and subscribes information to the driver station
    ...
    */
    ...
    //Immeadiately uploads all pending data to the NetworkTable
    public static void Flush() {
        NetworkTableInstance.getDefault().flush();
    }

    //Different types of entries publishing different types of data
    ...
    //Allows video captured from the Limelight to be saved and accessed through a URL
    ...
    //Figures out which target is specifically being looked at
    ...
    //Recording data
    //Pipeline: Small program that takes an image, processes the image, and provides a results object to be used in code
    ...
    /**
     * Incorrect spelling: Did you mean getBotPose (capital "P")?
     * 
     * @param limelightName
     * @return
     */
    ...
    /**
     * Incorrect spelling: Did you mean getBotPoseRed_wpiRed (capital "P")?
     * 
     * @param limelightName
     * @return
     */
    ...
    /**
     * Incorrect spelling: Did you mean getBotPoseRed_wpiBlue (capital "P")?
     * 
     * @param limelightName
     * @return
     */
    ...
    //Changes the orientation of the Limelight (I think) with or without updating the NetworkTables
    ...
    //Controls whether a Fiducial result is accepted
    ...
    //Downscaling: Process of reducing an image from a higher resolution to a lower resolution to more easily detect data form it
